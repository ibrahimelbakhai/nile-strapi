...
export interface ApiItemItem extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    Code: Attribute.String;
    Category: Attribute.Enumeration<['Cars', 'Generators', 'Pumps', 'Trucks']>;
    Chassis_number: Attribute.String;
    Motor_number: Attribute.String;
    Plate_number: Attribute.String;
    Model: Attribute.String;
    License_renewal_date: Attribute.Date;
    Equipment_type: Attribute.Enumeration<
      [
        '\u062E\u0644\u0627\u0637\u0647 \u0627\u0641\u064A\u0643\u0648',
        '\u0645\u0636\u062E\u0647 34',
        '\u0645\u0636\u062E\u064748',
...
export interface ApiJournalEntryJournalEntry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    station: Attribute.Relation<
      ...
      'api::station.station'
    >;
    EquipmentType: Attribute.Enumeration<['Mixer', 'Pump', 'Truck', 'Loader.']>;
    EquipmentId: Attribute.String;
    Productivity: Attribute.Float;
    NumberOfTrips: Attribute.Integer;
    OilConsumption: Attribute.Float;
    BakamOilConsumption: Attribute.Float;
    SolarConsumption: Attribute.Decimal;
    TrafficViolation: Attribute.Decimal;
    HeadOfMovement: Attribute.String;
    Driver: Attribute.String;
    Description: Attribute.Blocks;
    AttachedDocuments: Attribute.Media<
...
export interface ApiStationStation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    equipment: Attribute.Relation<
      ...
      'api::item.item'
    >;
    journal_entries: Attribute.Relation<
      'api::station.station',
      'oneToMany',
      'api::journal-entry.journal-entry'
    >;
